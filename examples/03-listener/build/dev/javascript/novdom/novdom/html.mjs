...
export function tr(parameters, children) {
  let _pipe = component("tr", children);
  return set_parameters(_pipe, parameters);
}

export function td(parameters, children) {
  let _pipe = component("td", children);
  return set_parameters(_pipe, parameters);
}

export function a(parameters, children) {
  let _pipe = component("a", children);
  return set_parameters(_pipe, parameters);
}

export function custom(tag, parameters, children) {
  let _pipe = component(tag, children);
  return set_parameters(_pipe, parameters);
}
