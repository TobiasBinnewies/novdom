...
-type pool(NQY, NQZ) :: {pool,
        glisten@socket:listen_socket(),
        fun((glisten@internal@handler:loop_message(NQY), NQZ, glisten@internal@handler:connection(NQY)) -> gleam@otp@actor:next(glisten@internal@handler:loop_message(NQY), NQZ)),
        integer(),
        fun((glisten@internal@handler:connection(NQY)) -> {NQZ,
            gleam@option:option(gleam@erlang@process:selector(NQY))}),
        gleam@option:option(fun((NQZ) -> nil)),
        glisten@transport:transport()}.
