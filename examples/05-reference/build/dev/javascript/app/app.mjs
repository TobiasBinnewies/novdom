...
import * as $reference from "../novdom/novdom/reference.mjs";
import { InnerHTML, Value } from "../novdom/novdom/reference.mjs";
...
export function main() {
  return $novdom.start(
    () => {
      ...
      return div(
        toList([class$("p-5 bg-blue-100"), $reference.set(ref, new InnerHTML())]),
        toList([
          div(
            toList([
