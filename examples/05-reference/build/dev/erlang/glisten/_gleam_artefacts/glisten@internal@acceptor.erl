...
-type pool(NYL, NYM) :: {pool,
        ...
        integer(),
        fun((glisten@internal@handler:connection(NYL)) -> {NYM,
            gleam@option:option(gleam@erlang@process:selector(NYL))}),
        gleam@option:option(fun((NYM) -> nil)),
        glisten@transport:transport()}.
