...
import { component, copy, document, set_child } from "../novdom/component.mjs";
...
import { ParameterContainer, get_component, set_parameters } from "../novdom/internals/parameter.mjs";
import * as $utils from "../novdom/internals/utils.mjs";
import * as $listener from "../novdom/listener.mjs";
import { onemouseover, onmousedown, onmousemove, onmouseout, onmouseup } from "../novdom/listener.mjs";
...
export function init() {
  ...
  set_parameters(
    ...
    toList([
      ...
      onmousemove((e) => { return store_mouse_position(e); }),
    ]),
  )
  let _pipe$1 = $state_component.utilize(
    drag_event,
    (event) => {
  ...
  return $render.add_to_viewport(_pipe$1, "_drag_");
}
