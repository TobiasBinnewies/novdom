...
export const clock_frames = toList([
  "🕛",
  "🕐",
  "🕑",
  "🕒",
...
export const half_circle_frames = toList(["◐", "◓", "◑", "◒"]);

export const moon_frames = toList([
  "🌑",
  "🌒",
  "🌓",
  "🌔",
...
export const negative_dots_frames = toList([
  "⣾",
  "⣽",
  "⣻",
  "⢿",
...
export const snake_frames = toList([
  "⠋",
  "⠙",
  "⠹",
  "⠸",
...
export const triangle_frames = toList(["◢", "◣", "◤", "◥"]);

export const walking_frames = toList([
  "⢄",
  "⢂",
  "⢁",
  "⡁",
