...
const year_units = toList(["y", "year", "years"]);

const month_units = toList(["mon", "month", "months"]);

const week_units = toList(["w", "week", "weeks"]);

const day_units = toList(["d", "day", "days"]);

const hour_units = toList(["h", "hour", "hours"]);

const minute_units = toList(["m", "min", "minute", "minutes"]);

const second_units = toList(["s", "sec", "secs", "second", "seconds"]);

const milli_second_units = toList([
  "ms",
  "msec",
  "msecs",
  "millisecond",
