...
export const unix_epoch = new Time(0, 0, new $option.None(), new $option.None());

const string_to_units = toList([
  ["year", new $duration.Year()],
  ["month", new $duration.Month()],
  ["week", new $duration.Week()],
  ["day", new $duration.Day()],
  ["hour", new $duration.Hour()],
  ["minute", new $duration.Minute()],
  ["second", new $duration.Second()],
]);
...
const units_to_string = toList([
  [new $duration.Year(), "year"],
  [new $duration.Month(), "month"],
  [new $duration.Week(), "week"],
  [new $duration.Day(), "day"],
  [new $duration.Hour(), "hour"],
  [new $duration.Minute(), "minute"],
  [new $duration.Second(), "second"],
]);
